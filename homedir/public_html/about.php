...
<body class="loaded pace-done pace-done" style="background-color:#fff">
                        ...
                        <div class="col-md-8 col-md-offset-2">
                            <div class="content-group-sm text-white">
                                <div class="search-header text-center mb-20">
                                    <h1 class="header-title"><font style="vertical-align: inherit;"><font class="" style="vertical-align: inherit;">درباره <?php echo $site_name; ?></font></h1>
                                    <h4 class="no-margin text-light header-subtitle"><span class="text-regular"><font style="vertical-align: inherit;line-height:40px;font-size:15px">تکنولوژی زندگی ساده تری برای ما ایجاد کرده است.از رزرو حمل و نقل گرفته تا سفارش غذا، همه و همه فقط با یک کلیک.ما معتقدیم که رزرو نوبت پزشک برای شما هم باید به همان سادگی باشد.به همین دلیل، <?php echo $site_name; ?> را ایجاد کردیم.از طریق وبسایت <?php echo $site_name; ?>، شما میتوانید بهترین پزشکان و مشاوران را تنها با چند کلیک، رزرو کنید.</font></span></h4>
    ...
    <div class="col-md-8" style="margin:0 auto;float:none;min-height:600px;border:10px solid #efefef;border-radius:10px;margin-top:-70px;position: relative;background-color:#fff;margin-bottom:30px"></div>
    </app-home>
