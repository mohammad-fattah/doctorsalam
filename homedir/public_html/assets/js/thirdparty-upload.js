...
$(document).ready(function(c) {
    ...
    }), $("#imgcart1").on("change", function(c) {
        $("#twopic").html("در حال آپلود ....");
        var e = $("#uploadForm2")[0],
            o = new FormData(e);
        c.preventDefault(), $.ajax({
            url: "/webservice/insurance/upload2.php",
            type: "POST",
            data: o,
            contentType: !1,
            cache: !1,
            processData: !1,
            success: function(c) {
                $("#twopic").html(c), "آپلود با موفقیت انجام شد" == c && ($("#twopic").css("color", "#41cc2d"), s = 1, $(".blockpic2").css("border-color", "#41cc2d"), $(".plus2").css("color", "#41cc2d"))
            }
        })
    }), $("#imgcart2").on("change", function(c) {
        $("#threepic").html("در حال آپلود ....");
        var e = $("#uploadForm3")[0],
            o = new FormData(e);
        c.preventDefault(), $.ajax({
            url: "/webservice/insurance/upload3.php",
            type: "POST",
            data: o,
            contentType: !1,
            cache: !1,
            processData: !1,
            success: function(c) {
                $("#threepic").html(c), "آپلود با موفقیت انجام شد" == c && ($("#threepic").css("color", "#41cc2d"), a = 1, $(".blockpic3").css("border-color", "#41cc2d"), $(".plus3").css("color", "#41cc2d"))
            }
        })
    }), $("#imgcart3").on("change", function(c) {
        $("#fourpic").html("در حال آپلود ....");
        var e = $("#uploadForm4")[0],
            o = new FormData(e);
        c.preventDefault(), $.ajax({
            url: "/webservice/insurance/upload4.php",
            type: "POST",
            data: o,
            contentType: !1,
            cache: !1,
            processData: !1,
            success: function(c) {
                $("#fourpic").html(c), "آپلود با موفقیت انجام شد" == c && ($("#fourpic").css("color", "#41cc2d"), n = 1, $(".blockpic4").css("border-color", "#41cc2d"), $(".plus4").css("color", "#41cc2d"))
            }
        })
