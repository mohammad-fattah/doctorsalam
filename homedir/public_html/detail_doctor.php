        ...
        <span style="color: rgb(2, 199, 115);">
                   <i class="icon-star-empty3"></i>
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="media stack-media-on-mobile" style="margin-top: 92px;">
                                        ...
                                        <div class="panel no-padding">
                                            <div class="panel-body pt-20">
											   ...
											   <div id="profile" class="tab">
												...
												<div style="display:none" id="advice" class="tab">
                                                    <div class="content-group no-margin">
                                                        <h5 class="text-pliro text-bold">توصیه های پزشک</h5>
                                                        <small>
														  <span class="">
                                                            راس ساعتی که در تقویم نوبت دهی انتخاب کرده اید به صورت تلفنی با دکتر گفتگو کنید!<br>
                                                            دکتر حداکثر تا ۱۵ دقیقه پاسخگوی سوال شما خواهد بود، درصورتی که نیاز به وقت بیشتری برای مشاوره تلفنی دارید میتوانید چند نوبت را رزرو کنید.<br>
                                                            نحوه انجام تماس، پس از ثبت نوبت و پرداخت وجه به شما نمایش داده می‌شود.<br>
                                                            توجه داشته باشید مشاوره تلفنی با پزشکان به منزله جایگزین ویزیت حضوری نمی‌باشد.<br>
                                                          </span>
														</small>
													 </div>
												</div>
												<div style="display:none" id="comment" class="tab">
                                                 <div class="content-group no-margin">
                                                    <p class="no-margin">
													 <h5 class="text-pliro text-bold">نظرات</h5>
													 <div class="content-group no-margin">
            ...
            <div class="navbar sub-header-nav">
                <div class="col-md-8" style="float:right">
                    <div class="media stack-media-on-mobile">
                        ...
                        <div class="media-body">
                            <p class="navbar-text pl-5 profile" style="text-align:right;float:right;cursor:pointer;border-bottom: 2px solid rgb(24, 83, 207); color: rgb(24, 83, 207); font-weight: 600;" onclick="ChangeTab('profile')">
                                مشخصات
                            </p>
                            <p class="navbar-text pl-5 advice" style="text-align:right;float:right;margin-right:20px;cursor:pointer" onclick="ChangeTab('advice')">
                                توصیه های پزشک
                            </p>
							<p class="navbar-text pl-5 comment" style="text-align:right;float:right;margin-right:20px;cursor:pointer" onclick="ChangeTab('comment')">
                               نظرات
                            </p>
                        </div>
                    </div>
