...
class Money_broker extends MY_Controller {
    ...
    function index() {
        ...
        $this->template->rander("money_broker/index", $view_data);
    }
    ...
    function modal_form() {
        ...
        $this->load->view('money_broker/modal_form', $view_data);
    }
    ...
    function list_data() {
        ...
        $list_data = $this->Clients_model->get_details($options,'broker')->result();
        $result = array();
    ...
    private function _make_row($data, $custom_fields) {
        ...
        $row_data = array($data->id,
            anchor(get_uri("money_broker/view/" . $data->id), $data->company_name),
        ...
        $row_data[] = modal_anchor(get_uri("money_broker/modal_form"), "<i class='fa fa-pencil'></i>", array("class" => "edit", "title" => lang('edit_client'), "data-post-id" => $data->id))
                . js_anchor("<i class='fa fa-times fa-fw'></i>", array('title' => lang('delete_client'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("money_broker/delete"), "data-action" => "delete"));
    ...
    function view($client_id = 0, $tab="") {
        ...
        if ($client_id) {
            ...
            if ($client_info) {
                ...
                $this->template->rander("money_broker/view", $view_data);
            } else {
                show_404();
            }
        } else {
    ...
    function add_remove_star($client_id, $type = "add") {
        if ($client_id) {
            ...
            if ($type === "add") {
                ...
                $this->load->view('money_broker/star/starred', $view_data);
            } else {
                $this->Clients_model->add_remove_star($client_id, $this->login_user->id, $type = "remove");
                $this->load->view('money_broker/star/not_starred', $view_data);
            }
        }
    }
    ...
    function show_my_starred_clients() {
        ...
        $this->load->view('money_broker/star/clients_list', $view_data);
    }
    ...
    function projects($client_id) {
        ...
        $view_data['client_id'] = $client_id;
        $this->load->view("money_broker/projects/index", $view_data);
    }
    ...
    function payments($client_id) {
        ...
        if ($client_id) {
            ...
            $view_data['client_id'] = $client_id;
            $this->load->view("money_broker/payments/index", $view_data);
        }
    }
    ...
    function tickets($client_id) {
        ...
        if ($client_id) {
            ...
            $this->load->view("money_broker/tickets/index", $view_data);
        }
    }
    ...
    function invoices($client_id) {
        ...
        if ($client_id) {
            ...
            $this->load->view("money_broker/invoices/index", $view_data);
        }
    }
    ...
    function estimates($client_id) {
        ...
        if ($client_id) {
            $view_data["client_info"] = $this->Clients_model->get_one($client_id);
            $view_data['client_id'] = $client_id;
            $this->load->view("money_broker/estimates/estimates", $view_data);
        }
    }
    ...
    function estimate_requests($client_id) {
        ...
        if ($client_id) {
            $view_data['client_id'] = $client_id;
            $this->load->view("money_broker/estimates/estimate_requests", $view_data);
        }
    }
    ...
    function notes($client_id) {
        ...
        if ($client_id) {
            $view_data['client_id'] = $client_id;
            $this->load->view("money_broker/notes/index", $view_data);
        }
    }
    ...
    function contact_profile($contact_id = 0, $tab = "") {
        ...
        if ($view_data['user_info']->user_type === "client") {
            ...
            $this->template->rander("money_broker/contacts/view", $view_data);
        } else {
            show_404();
        }
    }
    ...
    function contacts($client_id) {
        ...
        if ($client_id) {
            ...
            $this->load->view("money_broker/contacts/index", $view_data);
        }
    }
    ...
    function add_new_contact_modal_form() {
        ...
        $this->load->view('money_broker/contacts/modal_form', $view_data);
    }
    ...
    function contact_general_info_tab($contact_id = 0) {
        if ($contact_id) {
            ...
            $this->load->view('money_broker/contacts/contact_general_info_tab', $view_data);
        }
    }
    ...
    function company_info_tab($client_id = 0) {
        if ($client_id) {
            ...
            $view_data['label_column'] = "col-md-2";
            $view_data['field_column'] = "col-md-10";
            $this->load->view('money_broker/contacts/company_info_tab', $view_data);
        }
    }
    ...
    private function _make_contact_row($data, $custom_fields) {
        ...
        $contact_link = anchor(get_uri("money_broker/contact_profile/" . $data->id), $full_name . $primary_contact);
        ...
        $row_data[] = js_anchor("<i class='fa fa-times fa-fw'></i>", array('title' => lang('delete_contact'), "class" => "delete", "data-id" => "$data->id", "data-action-url" => get_uri("money_broker/delete_contact"), "data-action" => "delete"));
    ...
    function invitation_modal() {
        ...
        $view_data["client_info"] = $this->Clients_model->get_one($client_id);
        $this->load->view('money_broker/contacts/invitation_modal', $view_data);
    }
    ...
    function users() {
        if ($this->login_user->user_type === "client") {
            ...
            $this->template->rander("money_broker/contacts/users", $view_data);
        }
    }
