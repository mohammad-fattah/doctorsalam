...
class roles extends MY_Controller {
    ...
    function club_permissions($role_id) {
        if ($role_id) {
            $view_data['model_info'] = $this->Roles_model->get_one($role_id);
            ...
            $this->load->view("roles/club_permissions", $view_data);
        }
    }
    ...
    function save_permissions() {
        ...
        /**/
		$can_view_merchant = $this->input->post('can_view_merchant');
        /**/
        ...
        $permissions = array(
            "can_view_merchant" => $can_view_merchant,
            "leave" => $leave,
    ...
    //get role list data
    function list_data() {
        $list_data = $this->Roles_model->get_details(array("club" => $this->login_user->club_name))->result();
        $result = array();
