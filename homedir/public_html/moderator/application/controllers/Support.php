...
class Support extends MY_Controller {
    ...
    function index() {
        ...
        $this->template->rander("Support/index", $view_data);
    }
    ...
    function save() {
        ...
        if ($save_id) {
            ...
            if ($this->input->post("reload_list")) {
                ...
                $data = $this->load->view("Support/post_list", $view_data, true);
            }
    ...
    function view_post_replies($post_id) {
        ...
        $this->load->view("Support/reply_list", $view_data);
    }
    ...
    function post_reply_form($post_id) {
        ...
        $this->load->view("Support/reply_form", $view_data);
    }
