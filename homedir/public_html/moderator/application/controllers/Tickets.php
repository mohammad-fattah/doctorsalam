...
class Tickets extends MY_Controller {
    ...
    function modal_form() {
        ...
        $view_data['client_id'] = $this->login_user->user_key;//$this->input->post('client_id');
        if ($this->login_user->user_type == "client") {
            $view_data['client_id'] = $this->login_user->user_key;//$this->login_user->client_id;
        } else {
    ...
    function ticket_list_data_of_client($client_id = 0) {
