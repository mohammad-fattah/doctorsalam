...
class Userpoint extends MY_Controller {
    ...
    function __construct() {
        ...
        $this->load->model("Userpoint_categories_model");
    ...
    function index() {
        ...
        $view_data["categories"] = $this->Userpoint_categories_model->get_details(array("type" => $type, "only_active_categories" => true))->result();
        $view_data["type"] = $type;
        $this->template->rander("userpoint/index", $view_data);
    }
    ...
    function view($id = 0) {
        ...
        $view_data['categories'] = $this->Userpoint_categories_model->get_details(array("type" => $model_info->type))->result();
        $view_data['page_type'] = "article_view";

        $view_data['article_info'] = $model_info;

        $this->template->rander('userpoint/articles/view_page', $view_data);
    }
    ...
    function category($id) {
        ...
        $category_info = $this->Userpoint_categories_model->get_one($id);
        ...
        $view_data['categories'] = $this->Userpoint_categories_model->get_details(array("type" => $category_info->type))->result();
	...
	function market($id) {
        ...
        $this->template->rander("userpoint/market/view_page", $view_data);
    }
    ...
    function help_articles() {
        ...
        $view_data["type"] = "help";
        $this->template->rander("userpoint/articles/index", $view_data);
    }
    ...
    function categories() {
        ...
        $view_data["type"] = "help";
        $this->template->rander("userpoint/categories/index", $view_data);
    }
    ...
    function category_modal_form($type) {
        ...
        $view_data['model_info'] = $this->Userpoint_categories_model->get_one($id);
        $view_data['type'] = $type;
        $this->load->view('userpoint/categories/modal_form', $view_data);
    }
    ...
    function save_category() {
        ...
        $save_id = $this->Userpoint_categories_model->save($data, $id);
        if ($save_id) {
    ...
    function categories_list_data($type) {
        ...
        $list_data = $this->Userpoint_categories_model->get_details(array("type" => $type))->result();
        $result = array();
    ...
    private function _category_row_data($id) {
        $options = array("id" => $id);
        $data = $this->Userpoint_categories_model->get_details($options)->row();
    ...
    function article_form($type, $id = 0) {
        ...
        $view_data['type'] = $type;
        $view_data['categories_dropdown'] = $this->Userpoint_categories_model->get_dropdown_list(array("title"), "id", array("type" => $type));
        $this->template->rander('userpoint/articles/form', $view_data);
    }
