...
if (!function_exists('get_article_avatar')) {

    function get_article_avatar($image_name = "") {
        if ($image_name === "system_bot") {
            return base_url("assets/images/file_preview.jpg");
        } else if ($image_name) {
            return base_url(get_setting("article_image_path")) . "/" . $image_name;
        } else {
            return base_url("assets/images/file_preview.jpg");
        }
    }
