    ...
    <div class="panel panel-default">
        <div class="page-title clearfix">
			...
			<div class="title-button-group">
                <?php echo modal_anchor(get_uri("api/category_modal_form/" . $type), "<i class='fa fa-plus-circle'></i> " . "افزودن اعتبارسنجی", array("class" => "btn btn-default", "title" => "افزودن اعتبارسنجی")); ?>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#category-table").appTable({
            source: '<?php echo_uri("api/list_validation/") ?>',
            columns: [
