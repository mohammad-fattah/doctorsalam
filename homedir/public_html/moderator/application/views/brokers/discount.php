  ...
  <div class="panel panel-default">
    <div class="tab-title clearfix">
		...
		<div class="title-button-group">
         <?php echo modal_anchor(get_uri("brokers/discount_form/".$user_key), "<i class='fa fa-plus-circle'></i> " . "کارمزد", array("class" => "btn btn-default", "title" => "کارمزد")); ?>
        </div>
    </div>
...
<script type="text/javascript">
	$(document).ready(function () {
        $("#discount-table").appTable({
            source: '<?php echo_uri("brokers/discount_list/".$user_key) ?>',
            columns: [
