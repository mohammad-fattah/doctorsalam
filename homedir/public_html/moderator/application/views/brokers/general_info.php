<div class="tab-content">
    <?php echo form_open(get_uri("brokers/save_general_info/" . $user_info->id), array("id" => "general-info-form", "class" => "general-form dashed-row white", "role" => "form")); ?>
    <div class="panel">
        ...
        <div class="panel-body">
			...
			<div class="form-group">
			  ...
			  <div class=" col-md-6">
                <label for="name" class="col-md-3">آدرس مجازی</label>
                <div class="col-md-9">
                    <?php
                    echo form_input(array(
                        "id" => "skype",
                        "name" => "skype",
                        "value" => $user_info->skype,
                        "class" => "form-control",
