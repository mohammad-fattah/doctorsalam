...
<div id="page-content" class="p220 clearfix">
    <?php $this->load->view("brokers/profile_image_section"); ?>
    ...
    <ul data-toggle="ajax-tab" class="nav nav-tabs" role="tablist" style="justify-content: space-between;display:flex">
       <li><a  role="presentation" href="<?php echo_uri("brokers/general_info/".$user_key); ?>" data-target="#tab-general-info">مشخصات بازاریاب</a></li>
       <li><a role="presentation" href="<?php echo_uri("brokers/account_settings/".$user_key); ?>" data-target="#tab-account-settings"> <?php echo lang('account_settings'); ?></a></li>
       <li><a role="presentation" href="<?php echo_uri("brokers/order/".$user_key); ?>" data-target="#tab-cash-info"><?php echo lang('orders'); ?></a></li>
	   <li><a role="presentation" href="<?php echo_uri("brokers/discount/".$user_key); ?>" data-target="#tab-discount-info">کارمزد</a></li>
       <!--<li><a role="presentation" href="<?php echo_uri("brokers/card/" . $user_key); ?>" data-target="#tab-cards-info"> <?php echo lang('cards_bank'); ?></a></li>
	   <li><a role="presentation" href="<?php echo_uri("brokers/wallet/" . $user_key); ?>" data-target="#tab-wallet-info">کیف پول</a></li>
	   <!--<li><a role="presentation" href="<?php echo_uri("brokers/transaction/" . $user_key); ?>" data-target="#tab-transaction-info">پرداخت ها</a></li>
	   <li><a role="presentation" href="<?php echo_uri("brokers/chat/" . $user_key); ?>" data-target="#tab-chat-info">گفتگو ها</a></li>
	   <li><a role="presentation" href="<?php echo_uri("brokers/address/" . $user_key); ?>" data-target="#tab-address-info">آدرس ها</a></li>-->
    </ul>
