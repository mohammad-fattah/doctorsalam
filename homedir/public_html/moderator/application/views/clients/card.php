    ...
    <div class="panel panel-default">
        <div class="page-title clearfix">
			...
			<div class="title-button-group">
                <?php echo modal_anchor(get_uri("clients/card_modal_form/" . $user_key), "<i class='fa fa-plus-circle'></i> " . "افزودن کارت", array("class" => "btn btn-default", "title" => "کارتهای بانکی")); ?>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#card-table").appTable({
            source: '<?php echo_uri("clients/card_list_data/$user_key") ?>',
            columns: [
