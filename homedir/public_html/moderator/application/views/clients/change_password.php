...
<div id="page-content" class="p220 clearfix">
    ...
    <ul data-toggle="ajax-tab" class="nav nav-tabs" role="tablist" style="display:none">
        ...
        <?php //if ($show_general_info) { ?>
            <!--<li><a  role="presentation" href="<?php echo_uri("clients/general_info/" . $user_info->id); ?>" data-target="#tab-general-info">مشخصات کاربر</a></li>-->
        <?php //} ?>
        ...
        <?php if ($show_projects) { ?>
            <li><a role="presentation" href="<?php echo_uri("clients/cash_info/" . $user_info->id); ?>" data-target="#tab-cash-info">تراکنش های نقدی</a></li>
			<li><a role="presentation" href="<?php echo_uri("clients/credit_info/" . $user_info->id); ?>" data-target="#tab-credit-info">تراکنش های اقساطی</a></li>
        <?php } ?>
    </ul>
