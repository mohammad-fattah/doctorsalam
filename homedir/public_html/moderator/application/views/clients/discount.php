<div id="page-content" class="p20 clearfix">
  <div class="panel panel-default">
    <div class="tab-title clearfix">
        <h4>شخص سازی تخفیف ها</h4>
		<div class="title-button-group">
         <?php echo modal_anchor(get_uri("clients/discount_form/".$user_key), "<i class='fa fa-plus-circle'></i> " . "افزودن", array("class" => "btn btn-default", "title" => "افزودن تخفیف")); ?>
        </div>
    </div>
...
<script type="text/javascript">
	$(document).ready(function () {
        $("#discount-table").appTable({
            source: '<?php echo_uri("clients/discount_list/".$user_key) ?>',
            columns: [
