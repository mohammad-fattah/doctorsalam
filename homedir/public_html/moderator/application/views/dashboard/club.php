			...
			<div class="col-md-4 col-sm-4">
                <div class="card card-stats">
                    ...
                    <div class="card-footer">
                        <div class="stats"> کل اعضا : <span class="dash_allvisitor"><?php if($count_client[0]){echo $count_client[0];}else{echo '0';} ?></span> نفر </div>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-sm-4">
                <div class="card card-stats">
                    ...
                    <div class="card-content">
                        <p class="category">تراکنش های نقدی</p>
                        <h3 class="card-title" ><?php if($count_order[0]){echo number_format($count_order[0]);}else{echo '0';} ?></h3></div>
                    <div class="card-footer">
                        <div class="stats"> تراکنش های اعتباری : <span class="dash_alloperator"><?php if($count_order[1]){echo number_format($count_order[1]);}else{echo '0';} ?> تومان</span></div>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-sm-4">
