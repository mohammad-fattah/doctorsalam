            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-content font14">
                        <h4 class="card-title">آخرین تراکنش‌های انجام شده</h4></div>
                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <div class="col-md-12">
                            ...
                            <br>
                            <p class="dash_bar_t"><i class="material-icons">chat_bubble_outline</i>مبلغ تراکنش ها : <span class="dash_c1">0</span></p>
                        ...
                        <div class="col-md-12" rel="tooltip" data-placement="top auto" title="" data-original-title="بسته شما اتوماتیک بصورت رایگان ماهانه تمدید خواهد شد">
                            <br>
                            <p class="dash_bar_t"><i class="material-icons">history</i>دعوت از دوستان : <span class="dash_c3">0</span> نفر</p>
                            <div class="progress progress-line-success">
                                <div class="progress-bar progress-bar-success dash_c33" style="width: 0%;"></div>
                            </div>
                        </div>
                        <div class="col-md-12 text-center"><a class="btn btn-danger btn-round btn-normal font14" id="bill_but" data-navigo="">ارتقا به سطح بالاتر</a><!--href="/upgrade"-->
                            <br>
                            <br>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card changelog_box">
                    <div class="card-content font14">
                        <h4 class="card-title"><i class="material-icons text-warning">new_releases</i>آخرین به روز رسانی بیمیتک <a href="/app" target="_blank"><i class="material-icons text-info">launch</i></a><div class="version">نسخه 1.0.2<span>98/01/29</span></div></h4></div>
                    <div class="col-md-12 changelog_box_c">
                        <div><i class="material-icons text-warning">chevron_left</i>انتشار اپلیکیشن اندروید بیمیتک نسخه 1.0.1</div>
