...
<div id="page-content" class="p220 clearfix">
    ...
    <ul data-toggle="ajax-tab" class="nav nav-tabs" role="tablist" style="justify-content: space-between;display:flex">
       ...
       <li><a role="presentation" href="<?php echo_uri("doctor/order/".$id); ?>" data-target="#tab-cash-info"><?php echo lang('orders'); ?></a></li>
	   <li><a role="presentation" href="<?php echo_uri("doctor/address/" . $user_key); ?>" data-target="#tab-address-info">آدرس ها</a></li>
	   <li><a role="presentation" href="<?php echo_uri("doctor/comment/" . $user_key); ?>" data-target="#tab-comment-info">نظرات کاربران</a></li>
    ...
    <div class="tab-content" style="background-color:#fff">
        ...
        <div role="tabpanel" class="tab-pane fade" id="tab-comment-info"></div>
