...
<?php $this->load->view("help_and_knowledge_base/articles/article_image_section"); ?>
        <?php echo form_close(); ?>
    </div> 
</div> 
...
// image Upload
    $(document).ready(function () {
        ...
        $("#article-image-form").appForm({
            isModal: false,
            beforeAjaxSubmit: function (data) {
                $.each(data, function (index, obj) {
                    if (obj.name === "article_image") {
                        var article_image = replaceAll(":", "~", data[index]["value"]);
                        data[index]["value"] = article_image;
                    }
                });
            },
