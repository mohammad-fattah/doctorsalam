...
<div id="page-content" class="clearfix p20">
    <?php echo form_open(get_uri("videos/save_article"), array("id" => "article-form", "class" => "general-form", "role" => "form")); ?>
            ...
            <div class="page-title clearfix">
                <?php if ($model_info->id) { ?>
                    ...
                    <div class="title-button-group">
                        ...
                        <?php echo anchor(get_uri("videos/article_form/" . $type), "<i class='fa fa-plus-circle'></i> " . lang('add_video'), array("class" => "btn btn-default", "title" => lang('add_video'))); ?>
                    </div>
                <?php } else { ?>
