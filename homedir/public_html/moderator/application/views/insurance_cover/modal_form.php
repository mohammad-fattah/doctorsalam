<?php echo form_open(get_uri("insurance_cover/add_cover"), array("id" => "team_member-form", "class" => "general-form", "role" => "form")); ?>
    ...
    <div class="tab-content mt15">
        <div role="tabpanel" class="tab-pane active" id="general-info-tab">
        	<div class="form-group">
                ...
                <div class=" col-md-9">
					<?php
                     echo form_dropdown("staff_id", $staff_dropdown ,"", "class='select2' data-rule-required='true', data-msg-required='" . lang('field_required') . "'");
                    ?>
                </div>
            </div>
		</div>
		...
		<div class="form-group">
			<label for="last_name" class=" col-md-3">نام پوشش</label>
			<div class=" col-md-9">
				<?php
