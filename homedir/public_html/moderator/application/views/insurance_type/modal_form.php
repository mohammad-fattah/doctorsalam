<?php echo form_open(get_uri("insurance_type/add_type"), array("id" => "team_member-form", "class" => "general-form", "role" => "form")); ?>
    ...
    <div class="tab-content mt15">
        <div role="tabpanel" class="tab-pane active" id="general-info-tab">
        	<div class="form-group">
                ...
                <div class=" col-md-9">
					<?php
                     echo form_dropdown("staff_id", $staff_dropdown ,"", "class='select2' id='psp_category' data-rule-required='true', data-msg-required='" . lang('field_required') . "'");
                    ?>
                </div>
            </div>
		</div>
		...
		<div class="form-group">
			<label for="last_name" class=" col-md-3">نام انگلیسی نوع</label>
			<div class=" col-md-9">
				<?php
				echo form_input(array(
					"id" => "english_type",
    ...
    $(document).ready(function() {
        $("#team_member-form").appForm({
            onSuccess: function(result) {
                if (result.success) {
                    $("#type-table").appTable({newData: result.data, dataId: result.id});
                }
            },
            onSubmit: function() {
