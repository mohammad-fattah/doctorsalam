<div class="panel panel-default" style="margin-bottom:0">
    <div class="panel-heading">
        <i class="fa fa fa-file-text-o"></i>&nbsp; <?php //echo lang("invoice_statistics"); ?>نمودار سفارشات امروز
    </div>
        ...
        var invoiceStatisticsFlotchart = function () {
            var invoices =<?php echo $invoices; ?>,
                    ...
                    dataset = [
                        ...
                        {
                            label: "<?php //echo lang('invoice'); ?>ناموفق",
                            data: invoices,
                            color: "rgba(220,220,220, 1)",
                            lines: {
                                show: false
                        ...
                        {
                            label: "<?php //echo lang('payment'); ?>موفق",
                            data: payments,
                            color: "rgba(0, 179, 147, 1)",
                            lines: {
                                show: false
