...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#team_member-table").appTable({
            source: '<?php echo_uri("merchant/broker_list/") ?>',
            order: [[1, "asc"]],
            columns: [
			    {title: "ردیف", "class": "text-center w100"},
                //{title: "مشخصات پذیرنده", "class": "text-center w100"},
                {title: "نام پذیرنده", "class": "text-center w100"},
                {title: "تاریخ قراداد", "class": "text-center w100"},
                {title: "مدت قراداد", "class": "text-center w100"},
