    ...
    <div class="panel">
        ...
        <div class="panel-body">
          <div class="form-group">
			...
			<div class="form-group">
                <label for="name" class=" col-md-2">ایمیل</label>
                <div class=" col-md-10">  
                    <?php
                    echo form_input(array(
                        "id" => "email",
			...
			<div class="form-group">
                ...
                <div class=" col-md-10">
					<select class="select2" id="state" name="state" onchange="Func()">
                            ...
                            <option value="مرکزی" data-name="انتخاب شهر , اراک , آستانه , آشتیان , پرندک , تفرش , توره , خمین , خنداب , داودآباد , دلیجان , رازقان , زاویه , بیمی کالاه , سنجانشازند , غرق&zwnj;آباد , فرمهین , قورچی&zwnj;باشی , کرهرود , کمیجان , مأمونیه , محلات , میلاجرد , نراق , نوبران , نیم&zwnj;ورهندودر">مرکزی</option>
			...
			<div class="form-group">
                <label for="last_name" class=" col-md-2">توضیحات</label>
                <div class=" col-md-10">
                    <?php
                    echo form_input(array(
                        "id" => "comment",
                        "name" => "comment",
						"value" => $user_info->comment,
                        "class" => "form-control",
                        "placeholder" => "توضیحات",
						"autocomplete" => "off",
                        "data-rule-required" => true,
			...
			<div class="form-group">
                <label for="job_title" class=" col-md-2">شماره ثابت</label>
                <div class=" col-md-10">
                    <?php
                    echo form_input(array(
			...
			<div class="form-group">
                ...
                <div class=" col-md-10">
					<?php
					//var_dump($roles_dropdown);
                     echo form_dropdown("psp_category", $roles_dropdown, $user_info->psp_category, "class='select2' id='psp_category' data-rule-required='true', data-msg-required='" . lang('field_required') . "'");
                    ?>
                </div>
            </div>
			<div class="form-group">
                <label for="job_title" class=" col-md-2">عرض جغرافیا</label>
                <div class=" col-md-10">
                    <?php
                    echo form_input(array(
                        "id" => "lat",
			...
			<div class="form-group">
                <label for="job_title" class=" col-md-2">طول جغرافیا</label>
                <div class=" col-md-10">
                    <?php
                    echo form_input(array(
                        "id" => "long",
                        "name" => "long",
						"value" => $user_info->long,
                        "class" => "form-control",
                        "placeholder" => "طول جغرافیا",
                        "data-rule-required" => true,
                        "data-msg-required" => lang("field_required"),
                    ));
                    ?>
