<?php echo form_open(get_uri("merchant/add_merchant"), array("id" => "team_member-form", "class" => "general-form", "role" => "form")); ?>


<input type="hidden" name="club_name" value="<?php echo $club_name; ?>" />
			...
			<div class="form-group">
                ...
                <div class=" col-md-9">
                    ...
                    echo form_input(array(
						...
						"data-msg-minlength" => lang("enter_minimum_9_characters"),
						"maxlength"=>"10",
                        "data-rule-required" => true,
                        "data-msg-required" => lang("field_required"),
                    ));
            ...
            <div class="form-group">
                ...
                <div class=" col-md-9">
                    ...
                    echo form_input(array(
						...
						"data-msg-minlength" => lang("enter_minimum_10_characters"),
						"maxlength"=>"11",
                    ));
                    ?>
                </div>
