<?php echo form_open(get_uri("merchant/add_broker_merchant"), array("id" => "team_member-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    ...
    <div class="form-widget">
        <div class="widget-title clearfix">
            ...
            <div id="account-info-label" class="col-sm-4"><i class="fa fa-circle-o"></i><strong> مشخصات کاربری</strong></div> 
        </div>
    ...
    <div class="tab-content mt15">
        ...
        <div role="tabpanel" class="tab-pane" id="job-info-tab">
			...
			<div class="form-group">
                <label for="job_title" class=" col-md-3">انتخاب psp</label>
                <div class=" col-md-9">
                    <?php
			...
			<div class="form-group">
                <label for="job_title" class=" col-md-3">درصد تخفیف بانکی</label>
                <div class=" col-md-9">
                    <?php
                    echo form_input(array(
                        "id" => "off_bank",
			...
			<div class="form-group">
                <label for="job_title" class=" col-md-3">درصد تخفیف غیربانکی</label>
                <div class=" col-md-9">
                    <?php
                    echo form_input(array(
                        "id" => "off_no_bank",
			...
			<div class="form-group">
                <label for="job_title" class=" col-md-3">امتیاز</label>
                <div class=" col-md-9">
                    <?php
                    echo form_input(array(
                        "id" => "point",
			...
			<div class="form-group">
                <label for="job_title" class=" col-md-3">کارمزد</label>
                <div class=" col-md-9">
                    <?php
                    echo form_input(array(
                        "id" => "porsant",
        ...
        <div role="tabpanel" class="tab-pane" id="account-info-tab">
            <div class="form-group">
                <label for="job_title" class=" col-md-3">lat</label>
                <div class=" col-md-9">
                    <?php
                    echo form_input(array(
                        "id" => "lat",
			...
			<div class="form-group">
                <label for="job_title" class=" col-md-3">long</label>
                <div class=" col-md-9">
                    <?php
                    echo form_input(array(
                        "id" => "long",
