...
<div id="page-content" class="p220 clearfix">
    ...
    <ul data-toggle="ajax-tab" class="nav nav-tabs" role="tablist">
        ...
        <li><a role="presentation" href="<?php echo_uri("merchant/cash_info/" . $user_info->id); ?>" data-target="#tab-cash-info">تراکنش های نقد و اقساط</a></li>
		<li><a role="presentation" href="<?php echo_uri("merchant/discounts/" . $user_info->id); ?>" data-target="#tab-product-info">کد های تخفیف</a></li>
		<li><a role="presentation" href="<?php echo_uri("merchant/contract/" . $user_info->id); ?>" data-target="#tab-projects-info">قرادادها</a></li>
    </ul>
