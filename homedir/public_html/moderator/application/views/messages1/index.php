<div id="page-content" class="clearfix p20">
    ...
    <div class="bg-white mb15 p10 message-buttons" style="text-align:left">
    ...
    <div class="row">
        <div class="col-sm-12 col-md-5 massageleft">
                ...
                <div class="panel-heading clearfix">
                    <div class="pull-left p5">
                        ...
                        if ($mode === "inbox") {
                            ...
                            echo "<i class='fa fa-send'></i> ارسال شده";
                        }
                        ?>
                    </div>
        ...
        <div class="col-sm-12 col-md-7 massageright">
