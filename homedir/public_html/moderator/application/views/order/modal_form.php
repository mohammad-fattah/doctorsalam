<?php echo form_open(get_uri("lottery/save_category"), array("id" => "category-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
	...
	<div class="form-group">
        <label for="description" class=" col-md-3">تاریخ قرعه کشی</label>
        <div class=" col-md-9">
            <?php
            echo form_input(array(
                "id" => "lottery_date",
                "name" => "lottery_date",
                "value" => $model_info->lottery_date,
                "class" => "form-control",
                "placeholder" => "تاریخ قرعه کشی",
            ));
            ?>
        </div>
    </div>
	<div class="form-group">
        <label for="description" class=" col-md-3">حداقل امتیاز قرعه کشی</label>
        <div class=" col-md-9">
            <?php
            echo form_input(array(
                "id" => "lowest_score",
                ...
                "class" => "form-control",
                "placeholder" => "حداقل امتیاز قرعه کشی",
            ));
            ?>
        </div>
    </div>
	...
	<div class="form-group">
        <label for="description" class=" col-md-3">جوایز</label>
        <div class=" col-md-9">
            <?php
            echo form_textarea(array(
                "id" => "prize",
                "name" => "prize",
                "value" => $model_info->prize,
                "class" => "form-control",
                "placeholder" => "جوایز",
            ));
            ?>
