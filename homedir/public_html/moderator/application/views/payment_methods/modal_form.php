...
<div class="modal-body clearfix">
    ...
    <div class="form-group">
        <label for="title" class=" col-md-4">نام روش</label>
        <div class=" col-md-8">
            <?php
    ...
    <?php if ($model_info->online_payable == 1) { ?>
        <div class="form-group">
            <label for="available_on_invoice" class="col-md-4"><?php echo lang('available_on_invoice'); ?>
                <span class="help" data-toggle="tooltip" title="<?php echo lang('available_on_invoice_help_text'); ?>"></span>
            </label>
            <div class="col-md-8">
                <?php
        ...
        <div class="form-group">
            <label for="minimum_payment_amount" class="col-md-4"><?php echo lang('minimum_payment_amount'); ?>
                <span class="help" data-toggle="tooltip" title="کمترین مقدار حق واریز"></span>
            </label>
            <div class="col-md-8">
                <?php
                echo form_input(array(
