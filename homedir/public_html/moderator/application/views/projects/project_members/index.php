    ...
    <div class="tab-title clearfix">
        ...
        <div class="title-button-group">
            ...
            if ($can_add_remove_project_members) {
                echo modal_anchor(get_uri("projects/project_member_modal_form"), "<i class='fa fa-plus-circle'></i> " . "افزودن نماینده", array("class" => "btn btn-default", "title" => lang('add_member'), "data-post-project_id" => $project_id));
            }
            ?>
        </div>
    </div>
