...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#project-table").appTable({
            ...
            radioButtons: [{text: '<?php echo lang("open") ?>', name: "status", value: "open", isChecked: true}, {text: '<?php echo lang("completed") ?>', name: "status", value: "completed", isChecked: false}, {text: '<?php echo lang("canceled") ?>', name: "status", value: "canceled", isChecked: false}, {text: 'ارجاع داده شده', name: "status", value: "erja", isChecked: false}, {text: 'در حال صدور', name: "status", value: "sodor", isChecked: false}, {text: 'صادره شده', name: "status", value: "sader", isChecked: false}, {text: 'تحویل داده شده', name: "status", value: "tahvil", isChecked: false}],
