<?php echo form_open(get_uri("psp/save"), array("id" => "team-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    <input type="hidden" name="id" value="<?php echo $model_info->id; ?>" />
    <div class="form-group">
        <label for="title" class=" col-md-3">نام پی اس پی</label>
        <div class=" col-md-9">
            <?php
    ...
    <div class="form-group">
        ...
        <div class=" col-md-9">
            ...
            echo form_input(array(
                ...
                "class" => "form-control",
                "placeholder" => "نام انگلیسی پی اس پی",
                "data-rule-required" => true,
                "data-msg-required" => lang("field_required"),
            ));
            ?>
