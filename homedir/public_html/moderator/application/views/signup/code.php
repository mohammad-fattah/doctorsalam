...
<head>
    ...
    <title>پسورد | <?php echo get_setting('app_title'); ?></title>
                                    ...
                                    <div class="card">
                                        <div class="row inverse">
                                            <div class="col col-12">
                                                <?php echo form_open("signup/check_code", array("id" => "signup-form", "class" => "general-form", "role" => "form")); ?>
												    <input type="hidden" name="signup_key"  value="<?php echo $token; ?>" />
												    <input type="hidden" name="mobile"  value="<?php echo $mobile; ?>" />
                                                    <div class="group">
													    <p style="text-align: center; color: #f00;"><?php if($message): echo $message; endif; ?></p>
                                                        <label for="code" class="label">کد ارسال شده را وارد کنید</label>
														<?php
                                                         echo form_input(array("id" => "code","name" => "code","class" => "input","autofocus" => true,"data-rule-required" => true,"data-msg-required" => lang("field_required"),));
                                                        ?>
                                                    </div>
