...
<head>
    ...
    <title>عضویت | <?php echo get_setting('app_title'); ?></title>
                                    ...
                                    <div class="card">
                                        <div class="row inverse">
                                            <div class="col col-12">
                                                <?php echo form_open("signup/check_phone", array("id" => "signup-form", "class" => "general-form", "role" => "form")); ?>
												    <input type="hidden" name="signup_key"  value="<?php echo isset($signup_key) ? $signup_key : ''; ?>" />
                                                    <div class="group">
                                                        <label for="mobile" class="label">شماره تلفن همراه</label>
														<?php
                                                         echo form_input(array("id" => "mobile","name" => "mobile","class" => "input","autofocus" => true,"data-rule-required" => true,"data-msg-required" => lang("field_required"),));
                                                        ?>
                                                    </div>
													
                                                    <button class="button btn-success btn-full btn-primary" type="submit"><?php echo lang('signup'); ?></button>
                                                    <?php echo form_close(); ?>
                                                    <br><a href="/signin" class="">حساب کاربری دارید؟ وارد شوید</a>
												</div>
                                        </div>
                                    </div>
                                </div>
