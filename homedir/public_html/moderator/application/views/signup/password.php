                                    ...
                                    <div class="card">
                                        <div class="row inverse">
                                            <div class="col col-12">
                                                <?php echo form_open("signup/check_pass", array("id" => "signup-form", "class" => "general-form", "role" => "form")); ?>
												    <input type="hidden" name="signup_key"  value="<?php echo isset($signup_key) ? $signup_key : ''; ?>" />
                                                    <div class="group">
                                                        <label for="password" class="label">رمز عبور خود را وارد کنید</label>
														<?php
                                                         echo form_input(array("id" => "password","type"=>"password","name" => "password","class" => "input","autofocus" => true,"data-rule-required" => true,"data-msg-required" => lang("field_required"),));
                                                        ?>
                                                    </div>
													
                                                    <button class="button btn-success btn-full btn-primary" type="submit">ورود</button>
                                                    <?php echo form_close(); ?>
												</div>
                                        </div>
                                    </div>
