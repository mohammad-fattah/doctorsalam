                ...
                <div>
                    <div class="main">
                        <div class="wrap">
                            ...
                            <div class="row">
                                <div class="col col-12 offset-12" style="justify-content: center; align-items: center; display: flex;">
                                 <?php 
			                      foreach ($model_info as $team_member) {
									 if($team_member->title):
			                     ?> 
                                  <form action="finish" method="post" style="width:400px">								 
								   <div class="col col-12">
									<div class="card">
                                     <div class="row inverse">
                                      <div class="col col-12">
									   <input type="hidden" name="level" value="<?php echo $team_member->id; ?>" />
									   <input type="hidden" name="mobile"  value="<?php echo $mobile; ?>09135315801" />
									   <input type="hidden" name="price"  value="<?php echo $team_member->price_score; ?>" />
									   <p>برای تکمیل عضویت , مبلغ مورد نظر را پرداخت کنید</p>
									   <br><br>
									   <p>بسته <?php echo $team_member->title; ?> <br> مبلغ : <?php echo number_format($team_member->price_score); ?> تومان</p>
									   <br>
                                       <button class="button btn-success btn-full btn-primary" type="submit">پرداخت</button>
									  </div>
                                     </div>
                                    </div>
                                   </div>
