            ...
            <div class="auth">
                <div>
                    <div class="main">
                        <div class="wrap">
                            <div class="row">
                                <div class="col col-8 offset-2"><a href="/" target="_self" class="brand"><h1>sav</h1></a></div>
                            </div>
                            <div class="row">
                                        ...
                                        <div class="row inverse">
                                            <div class="col col-12">
                                                <?php echo form_open("signup/create_account", array("id" => "signup-form", "class" => "general-form", "role" => "form")); ?>
                                                    ...
                                                    <div class="group">
													    <p style="text-align: center; color: #f00;"><?php if($message_melli): echo $message_melli; endif; ?></p>
                                                        <label for="first_name" class="label">نام</label>
														<?php
                                                         echo form_input(array("id" => "first_name","name" => "first_name","class" => "input","autofocus" => true,"data-rule-required" => true,"data-msg-required" => lang("field_required"),));
                                                        ?>
                                                    </div>
													<div class="group">
                                                        <label for="last_name" class="label">نام خانوادگی</label>
														<?php
                                                         echo form_input(array("id" => "last_name","name" => "last_name","class" => "input","autofocus" => true,"data-rule-required" => true,"data-msg-required" => lang("field_required"),));
                                                        ?>
                                                    </div>
													<div class="group">
                                                        <label for="melli_code" class="label">کد ملی</label>
														<?php
                                                         echo form_input(array("id" => "melli_code","name" => "melli_code","class" => "input","autofocus" => true,"data-rule-required" => true,"data-msg-required" => lang("field_required"),));
                                                        ?>
                                                    </div>
													<div class="group">
                                                        <label for="password" class="label">پسورد</label>
														<?php
                                                         echo form_input(array("id" => "password","name" => "password","type" => "password","class" => "input","autofocus" => true,"data-rule-required" => true,"data-msg-required" => lang("field_required"),));
                                                        ?>
                                                    </div>
													<div class="group">
                                                        <label for="rpassword" class="label">تکرار پسورد</label>
														<?php
                                                         echo form_input(array("id" => "rpassword","name" => "rpassword","type" => "password","class" => "input","autofocus" => true,"data-rule-required" => true,"data-msg-required" => lang("field_required"),));
                                                        ?>
                                                    </div>
                                                    <button class="button btn-success btn-full btn-primary" type="submit"><?php echo lang('signup'); ?></button>
                                                    <?php echo form_close(); ?>
												</div>
                                        </div>
                                    </div>
