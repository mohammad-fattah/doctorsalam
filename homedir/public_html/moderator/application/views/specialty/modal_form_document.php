<?php echo form_open(get_uri("insurance_document/add_document"), array("id" => "team_member-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    ...
    <div class="tab-content mt15">
		...
		<div role="tabpanel" class="tab-pane active" id="general-info-tab">
        	<div class="form-group">
                <label for="job_title" class=" col-md-3">مدرک</label>
                <div class=" col-md-9">
					<?php
                     echo form_dropdown("type", $insurance_document ,$model_info->type, "class='select2' data-rule-required='true', data-msg-required='" . lang('field_required') . "'");
                    ?>
                </div>
            </div>
		</div>
		...
		<div class="form-group">
			<label for="last_name" class=" col-md-3">نام فارسی مدرک</label>
			<div class=" col-md-9">
				<?php
		...
		<div class="form-group">
			<label for="last_name" class=" col-md-3">نام انگلیسی مدرک</label>
			<div class=" col-md-9">
				<?php
				echo form_input(array(
					"id" => "element_name",
		...
		<div class="form-group">
			<label for="last_name" class=" col-md-3">الزامی / غیرالزامی</label>
			<div class=" col-md-9">
				<?php
