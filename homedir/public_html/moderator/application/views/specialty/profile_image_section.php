<div class="box" style="margin-bottom:20px">
    <div class="box-content w200 text-center profile-image">
        <?php
        $url = "insurance";
        echo form_open(get_uri($url . "/save_profile_image/".$id), array("id" => "profile-image-form", "class" => "general-form", "role" => "form"));
        ?>
        ...
        <span class="avatar avatar-lg"><img id="profile-image-preview" style="border-radius:0" src="<?php echo $pic; ?>" alt="..."></span>
        <?php echo form_close(); ?>
    </div>
</div>