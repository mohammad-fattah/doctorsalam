<style>.modal-footer .btn+.btn{float:left}</style>
<div class="box">
                        ...
                        <div class="media-body clearfix w100p">
                            ...
                            <div class="pull-right">
                                ...
                                if (get_setting("module_message")) {
                                    echo modal_anchor(get_uri("messages/modal_form/" . $member->id), "<i class='fa fa-envelope-o'></i>", array("class" => "btn btn-default btn-xs round","style"=>"min-width:30px;height:30px;line-height:30px;border:1px solid #e2e4e7 !important;padding:0", "title" => lang('send_message')));
                                }
                                ?>
                            </div>
                        </div>
