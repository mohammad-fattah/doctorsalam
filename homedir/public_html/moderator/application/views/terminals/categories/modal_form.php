<?php echo form_open(get_uri("terminals/save_category"), array("id" => "category-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    <!--<input type="hidden" name="id" value="<?php echo $model_info->id; ?>" />-->
    <input type="hidden" name="id" value="<?php echo $type; ?>" />
    <input type="hidden" name="merchant" id="merchant" value="<?php echo $merchant_id; ?>" />
   
    <div class="form-group">
        <label for="title" class=" col-md-3">عنوان ترمینال</label>
        <div class=" col-md-9">
            <?php
	...
	<div class="form-group">
        <label for="description" class=" col-md-3">آی دی ترمینال</label>
        <div class=" col-md-9">
            <?php
            echo form_input(array(
                "id" => "terminal_id",
                "name" => "terminal_id",
                "value" => $model_info->terminal_id,
                "class" => "form-control",
                "placeholder" => "آی دی ترمینال",
            ));
            ?>
        </div>
    </div>
	<div class="form-group">
        <label for="job_title" class="col-md-3">پی اس پی</label>
        <div class=" col-md-9">
			<?php
                echo form_dropdown("psp", $psp_dropdown , $model_info->psp, "class='select2' id='psp_category' data-rule-required='true', data-msg-required='" . lang('field_required') . "'");
            ?>
        </div>
    </div>
	<div class="form-group">
        <label for="job_title" class="col-md-3">نوع پی اس پی</label>
        <div class=" col-md-9">
	      <select class="select2" id="type" name="type">
           <option value="">نوع پی اس پی</option>
           <option value="GPRS" <?php if($model_info->type == "GPRS")echo "selected"; ?>>سیار (GPRS)</option>
           <option value="WIFI" <?php if($model_info->type == "WIFI")echo "selected"; ?>>اینترنتی (WIFI & LAN)</option>
           <option value="DIALUP" <?php if($model_info->type == "DIALUP")echo "selected"; ?>>ثابت (DIALUP)</option>
          </select>
        </div>
    </div>
	<div class="form-group">
        <label for="job_title" class="col-md-3">بازاریاب</label>
        <div class=" col-md-9">
			<?php
                echo form_dropdown("broker", $broker_dropdown , $model_info->email, "class='select2'");
            ?>
        </div>
    </div>
	<div class="form-group">
        <label for="job_title" class="col-md-3">نماینده</label>
        <div class=" col-md-9">
			<?php
                echo form_dropdown("agent", $agent_dropdown , $model_info->first_name, "class='select2'");
            ?>
        </div>
    </div>
	<div class="form-group">
        <label for="job_title" class="col-md-3">باشگاه</label>
        <div class=" col-md-9">
			<?php
                echo form_dropdown("club", $club_dropdown , $model_info->job_title, "class='select2'");
            ?>
        </div>
    </div>
	<div class="form-group">
        <label for="description" class=" col-md-3">استان</label>
        <div class=" col-md-9">
            <?php
            /*echo form_input(array(
                "id" => "state",
            ...
            ?>
			              <select class="select2" id="statei" name="state" onchange="Func()">
                            <option value="<?php echo $model_info->state; ?>" data-name="<?php echo $model_info->state; ?>" selected><?php echo $model_info->state; ?></option>
	...
	<div class="form-group">
        <label for="description" class=" col-md-3">شهر</label>
        <div class=" col-md-9">
            <?php
             /*echo form_input(array(
                "id" => "city",
            ...
            ?>
			<select class="select2" id="cityi" name="city">
              <option value="<?php echo $model_info->city; ?>" selected><?php echo $model_info->city; ?></option>
            </select>
        </div>
    </div>
	<div class="form-group">
        <label for="description" class=" col-md-3">آدرس</label>
        <div class=" col-md-9">
            <?php
            echo form_input(array(
                "id" => "address",
	...
	<div class="form-group">
        <label for="description" class=" col-md-3">تخفیف نقدی</label>
        <div class=" col-md-9">
            <?php
            echo form_input(array(
                "id" => "off_bank",
                "name" => "off_bank",
                "value" => $model_info->off_bank,
                "class" => "form-control",
                "placeholder" => "تخفیف نقدی",
            ));
            ?>
        </div>
    </div>
	<div class="form-group">
        <label for="description" class=" col-md-3">تخفیف غیر نقدی</label>
        <div class=" col-md-9">
            <?php
            echo form_input(array(
                "id" => "off_no_bank",
                "name" => "off_no_bank",
                "value" => $model_info->off_no_bank,
                "class" => "form-control",
                "placeholder" => "تخفیف غیر نقدی",
            ));
            ?>
        </div>
    </div>
	<div class="form-group">
        <label for="description" class=" col-md-3">کارمزد</label>
        <div class=" col-md-9">
            <?php
            echo form_input(array(
                "id" => "porsant",
                "name" => "porsant",
                "value" => $model_info->porsant,
                "class" => "form-control",
                "placeholder" => "کارمزد",
            ));
            ?>
...
var state=document.getElementById('statei');
