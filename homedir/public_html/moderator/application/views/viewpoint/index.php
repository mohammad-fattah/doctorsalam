<div id="page-content" class="p20 clearfix">
    <div class="panel panel-default">
        <div class="page-title clearfix">
            <h1><?php echo lang('viewpoint'); ?></h1>
            <div class="title-button-group">
                <?php
                if ($show_add_button) {
                    echo anchor(get_uri("viewpoint/form"), "<i class='fa fa-plus-circle'></i> " . lang('add_announcement'), array("class" => "btn btn-default", "data-modal-lg" => "1", "title" => lang('add_announcement')));
                };
                ?>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#announcement-table").appTable({
            source: '<?php echo_uri("viewpoint/list_data") ?>',
            order: [[2, "desc"]],
            columns: [
