    ...
    <div class="panel view-container">
        <div class="panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="clearfix">
                    <label for="start_date" class="col-md-1" style="float:right"><?php echo lang('start_date'); ?></label>
					...
					<label for="end_date" class="col-md-1" style="float:left"><?php echo lang('end_date'); ?></label>
                </div>
