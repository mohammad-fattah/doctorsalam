            ...
            <div class="col-md-12 col-sm-6">
                <div class="panel panel-default  text-center " style="background-color:#fff;">
                    <div class="panel-body">
                        ...
                        <div class="p15">
                            <input type="text" name="first_name" value="" id="first_name" class="form-control" placeholder="شماره همراه" autofocus="1" data-rule-required="1" data-msg-required="این فیلد مورد نیاز است." aria-required="true" style="background-color:#ebeff2;width:100%;margin-top:20px">
                            <input type="text" name="first_name" value="" id="first_name" class="form-control" placeholder="مبلغ به تومان" autofocus="1" data-rule-required="1" data-msg-required="این فیلد مورد نیاز است." aria-required="true" style="background-color:#ebeff2;width:100%;margin-top:20px">
                        </div>
                    </div>
                    <div class="panel-footer p15 no-border" style="background-color:#fff;margin-top:0">
                        <a href="store/2" class="btn btn-xs btn-info" style="width:100%;font-size:14px">انتقال وجه</a>
                    </div>
                </div>
            </div>
        </div>
